...
public class GreetingAspect {
    ...
    @AfterReturning("execution(* com.angel.curso.springboot.app.aop.springboot_aop.services.GreetingService.*(..))")
    ...
    @AfterThrowing("execution(* com.angel.curso.springboot.app.aop.springboot_aop.services.GreetingService.*(..))")
    ...
    @Around("execution(* com.angel.curso.springboot.app.aop.springboot_aop.services.*.*(..))")
    public Object loggerAround(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            logger.info("El metodo " + method + "() retorna el result " + result);
            return result;
        } catch (Throwable e) {
